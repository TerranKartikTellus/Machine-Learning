...
export default function Home() {
  ...
  const [data,setDate] = useState({b:0, h:0});
      ...
      <div className='w-1/2 pl-20 pr-10'>
        ...
        <div className='w-full bg-400 flex flex-row items-center justify-start space-x-5'>
          <div className='flex flex-col items-center justify-start'>
            ...
            <input id='b' onChange={(e)=>{setDate(
              {...data,b:e.target.value}
            )}} placeholder='7' className='ml-7 w-[60px] h-[60px] bg-transparent border-[2px] rounded-2xl border-gray-50/50 outline-none p-2 text-center font-thin' type={''}></input>
          </div>

          <div className='flex flex-col items-center justify-start mr-32'>
            <p className='text-white/80 mb-2 mt-4 text-sm'>Harness Size</p>
            <input id='h'  onChange={(e)=>{setDate(
              {...data,h:e.target.value}
            )}} placeholder='3' className='ml-7 w-[60px] h-[60px] bg-transparent border-[2px] rounded-2xl border-gray-50/50 outline-none p-2 text-center font-thin' type={''}></input>
          </div>
        ...
        <div className='font-thin tracking-wider mx-2 space-x-4 '>
          <button onClick={()=>{
            ...
            <div className='group'>
              <div><Image src={redImgIco} width={60} height={60} className="rounded-lg mb-2 group-hover:border-[2px] group-hover:border-white"></Image></div>
              <div>Red</div>
            </div>
          </button>
          <button onClick={()=>{
            ...
            <div className='group'>
              <div><Image src={blackImgIco} width={60} height={60} className="rounded-lg mb-2 group-hover:border-[2px] group-hover:border-white"></Image></div>
              <div>Black</div>
            </div>
          </button>
          <button onClick={()=>{
            ...
            <div className='group'>
              <div><Image src={grayImgIco} width={60} height={60} className="rounded-lg mb-2 group-hover:border-[2px] group-hover:border-white"></Image></div>
              <div>White</div>
            </div>
          </button>
...
function Logo(){
  return(
    <div className='absolute bottom-5 right-5 rounded-3xl group group-hover:block transition-transform duration-500 ease-in-out'>
      ...
      <a href='/' className='absolute w-[100px] top-5 -left-20 hidden group-hover:block transition-transform duration-500 ease-in-out translate-x-9 group-hover:translate-x-0 font-thin '>Woo Fogs</a>
...
function DevelopedBy(){
  return(
    <a href="https://www.linkedin.com/in/terrankartiktellus/" target="_blank" className='text-gray-50 absolute bottom-5 left font-thin ml-5  hover:underline rounded-3xl block'>
      Developed By TKT
    </a>
  );
}
...
function ShowImage({i}){
  return(
    <div className='w-full h-full '>
      <Image src={i} className='h-[full] rounded-l-[50px]' ></Image>
    </div>
  );
}
